...
def validate_data(input_path: str, validation_report_path: str):
    """
    ...
    for col in NUMERIC_COLUMNS:
        ...
        non_numeric = converted.isna() & df[col].notna()
    ...
    if "TotalCharges" in actual_columns:
        ...
        if blank_count > 0:
            warnings.append(f"Column 'TotalCharges' has " f"{blank_count} blank values")
